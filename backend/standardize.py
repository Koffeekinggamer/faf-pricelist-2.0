...
VENDOR_CANON = {
    ...
    "aj s furniture": "AJ's Furniture",
    "amish aspen": "Amish Aspen",
    "brookside home furnishings": "Brookside Home Furnishings",
    "fredericksburg furniture": "Fredericksburg Furniture",
    "frog pond furniture": "Frog Pond Furniture",
    "hillside chair": "Hillside Chair",
    "hogback design and finishing": "Hogback Design And Finishing",
    "j. troyer & company": "J. Troyer & Company",
    "j troyer and company": "J. Troyer & Company",
    "kidron woodcraft": "Kidron Woodcraft",
    "maple lane": "Maple Lane",
    "superior woodcrafts": "Superior Woodcrafts",
    "townline furniture": "Townline Furniture",
    "troyer ridge furniture": "Troyer Ridge Furniture",
    "patio kraft": "Patio Kraft",
    "patiokraft": "Patio Kraft",
    "beaverdam": "Beaverdam",
    "gvwi": "GVWI",
    "gable valley": "GVWI",
    "five star tables": "Five Star Tables",
    "five star": "Five Star Tables",
    "fivestartables": "Five Star Tables",
    "lamb": "LAMB",
...
_VENDOR_FILENAME_HINTS: list[tuple[re.Pattern, str]] = [
    ...
    (re.compile(r"(?i)fredericksburg\s+furniture"), "Fredericksburg Furniture"),
    (re.compile(r"(?i)five\s*star\s*tables|fivestartables"), "Five Star Tables"),
    (re.compile(r"(?i)frog\s+pond"), "Frog Pond Furniture"),
    (re.compile(r"(?i)hillside\s+chair"), "Hillside Chair"),
    (re.compile(r"(?i)hogback\s+design"), "Hogback Design And Finishing"),
    (re.compile(r"(?i)j\.?\s*troyer"), "J. Troyer & Company"),
    (re.compile(r"(?i)kidron\s+woodcraft"), "Kidron Woodcraft"),
    (re.compile(r"(?i)maple\s+lane"), "Maple Lane"),
    (re.compile(r"(?i)superior\s+woodcrafts"), "Superior Woodcrafts"),
    (re.compile(r"(?i)townline\s+furniture"), "Townline Furniture"),
    (re.compile(r"(?i)troyer\s+ridge"), "Troyer Ridge Furniture"),
