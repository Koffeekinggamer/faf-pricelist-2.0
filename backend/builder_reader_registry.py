...
DEFAULT_READER_REGISTRY = BuilderReaderRegistry(
    (
        ...
        ReaderEntry(
            "artisan_chairs",
            "Artisan Chairs",
            "wide_import:looks_like_artisan_chairs",
            "wide_import:import_artisan_chairs_workbook",
            ("artisan_chairs",),
        ),
        ReaderEntry(
            "criswell",
        ...
        ReaderEntry(
            "patio_kraft",
            "Patio Kraft",
            "wide_import:looks_like_patio_kraft",
            "wide_import:import_patio_kraft_workbook",
            ("patio_kraft",),
        ),
        ReaderEntry(
            "amish_aspen",
            "Amish Aspen",
            "wide_import:looks_like_amish_aspen",
            "wide_import:import_amish_aspen_workbook",
            ("amish_aspen",),
        ),
        ReaderEntry(
            "hillside_chair",
            "Hillside Chair",
            "wide_import:looks_like_hillside_chair",
            "wide_import:import_hillside_chair_workbook",
            ("hillside_chair",),
        ),
        ReaderEntry(
            "maple_lane",
            "Maple Lane",
            "wide_import:looks_like_maple_lane",
            "wide_import:import_maple_lane_workbook",
            ("maple_lane",),
        ),
        ReaderEntry(
            "hw_chair_markup",
            "Hope Wood",
            "wide_import:looks_like_hw_chair_markup",
            "wide_import:import_hw_chair_workbook",
            ("hw_chair", "hw_chair_markup"),
        ),
        ReaderEntry(
            "lamb",
            "LAMB",
            "wide_import:looks_like_lamb",
            "wide_import:import_lamb_workbook",
            ("lamb",),
        ),
        ReaderEntry(
            "luxhome",
        ...
        ReaderEntry(
            ...
            "wide_import:looks_like_windy_acres",
            "wide_import:import_windy_acres_workbook",
            ("windy_acres",),
        ),
