...
| [0002](./0002-retail-equals-wholesale-times-multiplier.md) | Retail = wholesale (cost) × multiplier, even-dollar ceil (2.7 / Genuine Oak 1.7) |
...
| [0011](./0011-builder-profiles.md)                         | Per-builder learned rules in `config/builder_profiles/*.json`    |
